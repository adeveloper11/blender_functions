...
def create_image_texture(material):
    ...
    current_node_location_x -= node_location_x_step
    image_path = "C:\\Users\\it\\Downloads\\road-220058_1920.jpg"
...
def add_camera():
    ...
    cam.name = "cam"
    cam.location = (7.61, -20.75, 5.33)
    cam.scale=(0.56, .170, 1.74)
    cam.rotation_euler[0] = math.radians(82)
    cam.rotation_euler[1] = math.radians(0)
    cam.rotation_euler[2] = math.radians(16)
    # track the object
...
# Get the world node tree
    ...
    image_path = "C:\\Users\\it\\Downloads\\meadow_4k.exr"
